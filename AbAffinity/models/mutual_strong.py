...
# ----------------------------------------------------------------------
try:
    from AbAffinity.utils.main_symmetric_mean import (
...
def evaluate(model, loader, device, pkd_bounds, return_ids=False):
    ...
    from AbAffinity.utils.main_symmetric_mean import pearson_correlation, spearman_correlation, rmse, r_squared
    metrics = {
